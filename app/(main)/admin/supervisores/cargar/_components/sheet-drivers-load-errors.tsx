  ...
  return (
    <Sheet open={wasError} onOpenChange={setWasError}>
      ...
      <SheetContent className="w-[400px] sm:w-[700px] md:w-fit  sm:max-w-none ">
        <SheetHeader>
          <SheetTitle className="text-red-600">Error al añadir Colaboradores</SheetTitle>
          <SheetDescription className="text-red-400 mb-2">
            Los siguientes usuarios <span className="font-bold"> No</span> se guardaron en el sistema
          </SheetDescription>
        </SheetHeader>
        <div className="h-[90%] w-full overflow-auto mt-2">
          <Table className="border border-red-500  overflow-hidden w-[700px]">
            <TableHeader>
              <TableRow>
