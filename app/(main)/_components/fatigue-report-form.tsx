...
export const FatigueReportForm = ({
  ...
  return (
    <div className="max-w-[1500px] w-full h-full mx-auto bg-slate-100 rounded-none overflow-y-hidden p-0  ">
      <div className="flex justify-between bg-slate-200 border-b-4 border-slate-500 p-2 place-items-center">
        ...
        <span className="flex flex-col text-start">
          <span className="font-bold text-lg">Supervisor:</span>
          {fatigueSleepReport.supervisor?.name}
        </span>
